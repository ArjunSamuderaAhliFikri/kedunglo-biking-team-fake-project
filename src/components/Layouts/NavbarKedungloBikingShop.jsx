...
const NavbarKedungloBikingShop = () => {
  return (
    <nav className="min-w-full min-h-[65px] bg-gradient-to-r from-[#F64C18] from-[45%] to-[#EE9539] flex justify-between items-center px-[60px]">
      <h1 className="capitalize font-semibold text-slate-100 text-xl font-inter">
