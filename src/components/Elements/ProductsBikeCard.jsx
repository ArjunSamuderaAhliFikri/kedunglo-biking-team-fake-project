            ...
            {cartProducts.map(product => (
                ...
                <div className="flex flex-col justify-center items-center bg-slate-200 w-full max-w-[250px] rounded-md overflow-hidden transition-all duration-150 group-hover:cursor-pointer group-hover:scale-95 group-hover:opacity-80">
                        ...
                        <div className="w-full my-3 px-5 mx-auto"> 
                            <h3 className="font-inter font-semibold capitalize text-slate-800 my-1 text-lg">{product.title}...</h3>
                        ...
                        <div className="flex justify-between items-center w-[100%]">
                            ...
                            <button onClick={() => handleAddProduct(product, product.id)} className="w-[50%] bg-sky-500 py-1 my-2 mx-auto rounded-md capitalize font-inter text-slate-100 font-semibold transition-all duration-150 hover:bg-sky-700" type="button">add to cart</button>
                        </div>
                </div>
            </div>
